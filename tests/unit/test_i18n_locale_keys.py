...
REQUIRED_KEYS = (
    ...
    "memory.repetitionInsightsPending",
    ...
    "memory.repetitionInsightsEffectRange",
    "memory.repetitionInsightsDays7",
    "memory.repetitionInsightsDays30",
    "memory.repetitionInsightsDays90",
