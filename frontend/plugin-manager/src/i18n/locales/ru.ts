...
export default {
  ...
  development: {
    ...
    guideTitle: "Начните разработку плагина",
    guideIntro: "Подключите свою папку исходников для разработки, отладки и сборки плагина без клонирования основного репозитория N.E.K.O.",
    guideLoadTitle: "Подключите исходники",
    guideLoadBody: "Включите режим разработки, выберите папку с plugin.toml, проверьте и загрузите её. Путь, введённый в браузере, относится к машине с сервером.",
    guideReloadTitle: "Измените и перезагрузите",
    guideReloadBody: "Сохраните изменения в редакторе и перезагрузите плагин. В списке точек входа появятся новые описания. После перезапуска приложения плагины разработки нужно запускать вручную.",
    guideBuildTitle: "Соберите и поделитесь",
    guideBuildBody: "Создайте пакет .neko-plugin, даже если плагин остановлен. Перед распространением импортируйте и проверьте его в другом окружении.",
    guideData: "Удаление связи останавливает плагин и удаляет регистрацию, сохраняя исходники и рабочие данные. Отключение режима разработки останавливает плагины, но сохраняет связи с папками.",
    guideReopen: "Руководство можно открыть снова кнопкой в правом верхнем углу страницы.",
    guideDismiss: "Понятно",
    sourcePlaceholder: "Выберите папку плагина с файлом plugin.toml",
    previewHint: "Проверьте папку, чтобы просмотреть сведения о плагине перед загрузкой.",
    title: "Режим разработчика",
    load: "Загрузить распакованный плагин",
    hint: "Загрузите исходники после разработки, затем соберите и импортируйте плагин или продолжите разработку.",
    badge: "Разработка",
    entry: "Точка входа",
    openSource: "Открыть папку исходников",
    start: "Запустить",
    stop: "Остановить",
    reload: "Перезагрузить",
    logs: "Журнал",
    build: "Собрать пакет",
    rebind: "Изменить папку",
    remove: "Удалить привязку",
    pathHint: "Укажите папку исходников на компьютере, где работает сервер N.E.K.O. Загрузка папки через браузер не поддерживается.",
    path: "Папка исходников",
    choose: "Выбрать папку",
    valid: "Проверка пройдена",
    validate: "Проверить",
    failed: "Операция не выполнена",
    built: "Пакет создан. Функциональное тестирование и проверка магазина выполняются отдельно.",
    removeHint: "Остановить плагин и удалить привязку? Исходники и рабочие данные сохранятся.",
  },
  common: {
    loading: 'Загрузка...',
    refresh: 'Обновить',
