...
export default {
  ...
  knowledge: {
    ...
    packageStatus: 'Estado dos pacotes', sourceDistribution: 'Distribuição de fontes', inactivePacks: 'Desativados', needsAttention: 'Precisa de atenção', materialMix: 'Tipo de pacote', noPacks: 'Nenhum pacote',
